 ...
 */
namespace CharZam\Database\Model\ResourceModel\Workout;

class Collection extends \Magento\Framework\Model\ResourceModel\Db\Collection\AbstractCollection
{
    /**
     * Connect the model to the resource model
     */
    protected function _construct()
    {
        $modelName = \CharZam\Database\Model\Workout::class;
        $resourceModelName = \CharZam\Database\Model\ResourceModel\Workout::class;
        $this->_init($modelName, $resourceModelName);
    }
}
